  ...
  const experiences = [
    {
      ...
      description: 'Working as a Java Full Stack Developer, contributing to full-stack web application development using Java, Spring Boot, React.js, MySQL, and REST APIs.',
      responsibilities: [
        ...
        'Designed and handled database-driven modules using MySQL and Spring Data JPA',
    ...
    },
    {
      ...
      description: 'Developed TaxPal, a MEAN stack web application for personal finance and tax management as part of Infosys Springboard 6.0. The application included transactions, budgets, tax estimator, tax calendar, and reports. Worked in a collaborative team, implemented secure JWT-based APIs, and deployed the application using Vercel for frontend and Render for backend.',
      responsibilities: [],
      techStack: [
