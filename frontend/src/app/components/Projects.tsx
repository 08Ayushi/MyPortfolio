...
export function Projects() {
  ...
  const projects: Project[] = [
    {
      name: 'RaahSetu – Smart Transit Recommendation System',
      github: 'https://github.com/08Ayushi/RaahSetu',
      liveDemo: '#',
      techStack: ['React.js', 'Vite', 'Spring Boot', 'Java 11', 'MySQL', 'Spring Security', 'JWT', 'REST APIs'],
      description: 'A full-stack BRTS route recommender and journey planner for Ahmedabad. It helps users search routes, find nearby stops, plan journeys, and access transport-related information through a responsive web application.',
      features: [
    ...
    },
    {
      ...
      github: 'https://github.com/08Ayushi/Bus-Booking-System',
      liveDemo: '#',
      techStack: ['React', 'Vite', 'Spring Boot', 'Java 8', 'MySQL'],
      description: 'A full-stack bus booking system with modules for route search, seat booking, ticket viewing, and booking management.',
      features: [
        'Admin and passenger role-based flows',
    ...
    },
    {
      ...
      description: 'A real-time collaborative code editor that allows multiple users to edit code together and run code with live input/output streaming.',
      features: [
    ...
    {
      name: 'Gujarati Sign Language Translator',
      github: 'https://github.com/08Ayushi/Gujarati-Sign-Language-Translator',
      liveDemo: '#',
      techStack: ['HTML', 'CSS', 'JavaScript', 'Node.js', 'MongoDB', 'Web Speech API'],
      description: 'A responsive full-stack web application for Gujarati speech/text-to-sign translation using MongoDB and avatar-based sign rendering.',
      features: [
        'Gujarati speech and text input',
        'Web Speech API integration',
        'MongoDB-based sign data storage',
        'HamNoSys-based output generation',
